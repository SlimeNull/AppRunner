...
{
    class EnvironmentVariablesToTextConverter : SingletonValueConverterBase<EnvironmentVariablesToTextConverter, List<ReferenceKeyValuePair<string, string>>, string>
    {
